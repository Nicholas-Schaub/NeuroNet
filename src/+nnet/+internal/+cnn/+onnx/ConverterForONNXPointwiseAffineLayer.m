classdef ConverterForONNXPointwiseAffineLayer < nnet.internal.cnn.onnx.NNTLayerConverter
    
    % Copyright 2018 The Mathworks, Inc.
    
    methods
        function this = ConverterForONNXPointwiseAffineLayer(layerAnalyzer)
