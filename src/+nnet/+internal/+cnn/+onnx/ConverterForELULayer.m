classdef ConverterForELULayer < nnet.internal.cnn.onnx.NNTLayerConverter
    % Class to convert a ReluLayer into ONNX
        
    % Copyright 2018 The Mathworks, Inc.

    methods
        function this = ConverterForELULayer(layerAnalyzer)
