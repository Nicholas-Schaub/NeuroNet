...
methods
    function outputs = forward(obj, inputs, params)
      outputs{1} = vl_nnfscore(inputs{1}, inputs{2}, [],'beta',obj.beta,...
                               'type',obj.type,'numClasses',obj.numClasses);
      n = obj.numAveraged ;
      m = n + size(inputs{1},4) ;
    ...
    function [derInputs, derParams] = backward(obj, inputs, params, derOutputs)
      ...
      if length(inputs)>2
        derInputs{1} = obj.vl_nnfscore(inputs{1}, inputs{2}, derOutputs{1},...
                                       'beta',obj.beta,'type',obj.type,...
                                       'numClasses',obj.numClasses,'instanceWeights',inputs{3}) ;
      else
        derInputs{1} = obj.vl_nnfscore(inputs{1}, inputs{2}, derOutputs{1},...
                                       'beta',obj.beta,'type',obj.type,...
